...
def suggest_adv_only(trial):
    params = {
        "batch_size":    trial.suggest_categorical("batch_size", [32]),  # 可改成 [32, 48, 64]
        ...
        "im_weight":     trial.suggest_categorical("im_weight", [0.5,0.7,0.9]),
        "im_T":          trial.suggest_categorical("im_T", [0.8,1.0,1.2])
    }
    return params
...
def objective_adv_only(trial,
    ...
    best_val = train_dann_infomax(model, src_tr, tgt_tr,src_va,
